...
<!--</style>-->
        ...
        <div class="row" style="padding-bottom:0px;">
                ...
                <img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/one.png')}}"></div>
                <div class="card border col-md-1  mt-4" style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 2" onclick="result_insert(2)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/two.png')}}"></div>
                <div class="card border col-md-1  mt-4" style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 3" onclick="result_insert(3)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/three.png')}}"></div>
                <div class="card border col-md-1  mt-4" style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 4" onclick="result_insert(4)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/four.png')}}"></div>
                <div class="card border col-md-1  mt-4" style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 5" onclick="result_insert(5)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/five.png')}}"></div>
                
                <div class="card border col-md-1  mt-4" style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 6" onclick="result_insert(6)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/six.png')}}"></div>
                <div class="card border col-md-1  mt-4" style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 7" onclick="result_insert(7)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/seven.png')}}"></div>
                <div class="card border col-md-1  mt-4 " style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 8" onclick="result_insert(8)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/eight.png')}}"></div>
                <div class="card border col-md-1 mt-4 " style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 9" onclick="result_insert(9)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/nine.png')}}"></div>
                <div class="card border col-md-1  mt-4" style="height: 90px; display: flex; justify-content: center; align-items: center;" title="Tap to insert result 0" onclick="result_insert(0)"><img style="height: 80px; width: 80px;" src="{{asset('/assets/spin/zero.png')}}"></div>
          </div>
...
<div class="row">
  <div class="form-group col-md-5">
    ...
    <div class="checkbox-group">
       <!--Loop through jackpot multipliers -->
