...
if($role == '1'){
    ...
    // You can handle other cases here, if needed.
             ...
             $a =  '<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="'.route('player.index') .'" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Players</span></a></li>';
             
       
         $b = '<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="m-r-10 mdi mdi-settings-box"></i><span class="hide-menu">Blue 36 Game</span></a>
        ...
        <li class="sidebar-item"> <a href="'.route('blue36.index').'" class="sidebar-link"> <i class="mdi mdi-emoticon"></i><span class="hide-menu">Admin Results</span></a></li>
        </ul> 
        </li>';
        
        $c = '<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="m-r-10 mdi mdi-settings-box"></i><span class="hide-menu">Green 36 Game</span></a>
        <ul aria-expanded="false" class="collapse first-level">
        ...
        <li class="sidebar-item"> <a href="'.route('green36.results').'" class="sidebar-link"> <i class="mdi mdi-emoticon"></i><span class="hide-menu">Bets Results</span></a></li>
        <li class="sidebar-item"> <a href="'.route('green36.index').'" class="sidebar-link"> <i class="mdi mdi-emoticon"></i><span class="hide-menu">Admin Results</span></a></li>
        </ul> 
        </li>';
        
         $d =  '<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="'.route('ChangePasswordIndex').'" aria-expanded="false"><i class="mdi mdi-blur-linear"></i><span class="hide-menu">Change Password</span></a></li>';
