...
//     }
//     $query = "SELECT `game_id`, `win_amount`, `win_number`, `amount`, `games_no` FROM `green_36_bets` ";
...
// 		$result_count=DB::select("SELECT COUNT(`id`) as id FROM `green_36_bets` where user_id=$userid");
